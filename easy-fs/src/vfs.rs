...
impl Inode {
    ...
    pub fn create(&self,name:&str)->Option<Arc<Inode>>{
        ...
        if self.modify_disk_inode(|root_node|{
        ...
        .lock().modify(new_inode_block_offset, |new_node:&mut DiskInode|{
            new_node.initialize(DiskInodeType::File);
        });
    ...
    pub fn clear(&self){
        ...
        self.modify_disk_inode(|disk_inode|{
            ...
            let need_dealloc_blocks=DiskInode::total_blocks(size);
            assert!(data_blocks_dealloc.len()==need_dealloc_blocks as usize);
    ...
    pub fn increase_size(&self,new_size:u32,disk_inode: &mut DiskInode,fs:&mut MutexGuard<EasyFileSystem>){
